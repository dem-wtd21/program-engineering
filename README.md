...
**Вывод:** Я научилась создавать множества, которые включают исходные числа и их строковое представление, повторяющееся от двух раз до их частоты, используя при этом Counterдля подсчета.
